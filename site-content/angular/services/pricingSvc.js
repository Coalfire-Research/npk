				...
				for (let name in regions) {
					promises.push(new Promise(function(resolve, reject) {
						...
						regions[name].describeSpotPriceHistory({
							...
							self.spotPriceHistory[regions[name].config.region][instanceType] = data;
							resolve(data);
						});
					}));
				};
