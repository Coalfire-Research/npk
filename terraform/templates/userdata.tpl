...
echo "* * * * * root aws s3 sync /var/log/cloud-init-output.log s3://$USERDATA/$ManifestPath/potfiles/" >> /etc/crontab
...
cp /var/log/cloud-init-output.log /potfiles/i-$${INSTANCE_ID}-output.log
